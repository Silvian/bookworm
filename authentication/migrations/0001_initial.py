    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(0, 'email'), (1, 'mobile number'), (2, 'landline number'), (3, 'postal address'), (4, 'billing address'), (5, 'social network id')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_display', models.CharField(max_length=254)),
